...
CCECAudioSystem::CCECAudioSystem(CCECProcessor *processor, cec_logical_address address, uint16_t iPhysicalAddress /* = CEC_INVALID_PHYSICAL_ADDRESS */) : CCECBusDevice(processor, address, iPhysicalAddress),
...
{
    uint16_t audioAddress = !!device ? device->GetCurrentPhysicalAddress() : CEC_INVALID_PHYSICAL_ADDRESS;
