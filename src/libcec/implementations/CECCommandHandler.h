...
#define COMMAND_HANDLED 0xFF
    ...
    public:
        ...
        virtual bool TransmitArcStarted(const cec_logical_address iInitiator, const cec_logical_address iDestination);
    ...
    protected:
        ...
        virtual int HandleSystemAudioArcStart(const cec_command &command);
